...
public class BMCHelp
{
    ...
    public boolean Komehelp(BMCPlayer player)
    {
        ...
        player.msg(bmc.equalMessage(content));
        player.msg(cmdname + "point <プレイヤー名>" + h + "コシヒカリ交換可能チケット数を表示します。");
        player.msg(cmdname + "get" + h + "コシヒカリをインベントリに追加します。");
    ...
    public boolean RankupProcessInfo(BMCPlayer bmcPlayer)
    {
        ...
        bmcPlayer.msg("2. " + "1. で作成したランクアイテムを手に持ち、" + " /rankup コマンドを実行します。");
